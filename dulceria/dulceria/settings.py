...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-f9y16jte5#jn7wv)m^f0nj-gnlp+o#5aret5!(j5z_ars10fd^')
...
MIDDLEWARE = [
    ...
    'dulceria.middleware.RolePermissionMiddleware',
]
...
if DATABASE_ENGINE == 'django.db.backends.mysql':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DATABASE_NAME', 'dulceria_lilis'),
    ...
    # Configuración para SQLite (respaldo)
    DATABASES = {
        'default': {
